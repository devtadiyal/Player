...
public class MainActivity extends Activity {
    ...
    Button buttonStart, buttonStop, buttonPlayLastRecordAudio, buttonStopPlayingRecording, recordedlist ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recordedlist = (Button) findViewById(R.id.button5);
        ...
        recordedlist.setOnClickListener(new View.OnClickListener() {
            @Override
